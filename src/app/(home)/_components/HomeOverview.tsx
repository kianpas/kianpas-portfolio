...
const HomeOverview = ({ posts, projects }: Props) => {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-12">
      <div className="mb-6 flex flex-wrap items-baseline justify-between gap-x-6 gap-y-2 sm:mb-8">
      ...
      <section aria-labelledby="latest-heading">
        ...
        {latestPost && (
          <PostRow post={latestPost} variant="featured" className="py-4 sm:py-6" />
        )}
      </section>

      <section className="mt-10 grid gap-12 border-t border-gray-200 pt-8 dark:border-gray-700 lg:grid-cols-[1.35fr_1fr] lg:gap-20" aria-labelledby="more-heading">
        <div>
