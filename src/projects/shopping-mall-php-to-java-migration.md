...
- 레거시 PHP 마일리지 로직을 Java로 재구현하며 적립·사용·소멸·취소 전반을 안정적으로 이관
- 일일 마일리지 소멸·예약 문자 발송 등 핵심 작업을 배치로 자동화

<!-- TODO: 정량 성과를 추가하면 설득력이 커집니다. (예: 마이그레이션 대상 규모, 배치 처리 건수/시간, 장애·오류율 변화, 성능 개선 수치) -->
